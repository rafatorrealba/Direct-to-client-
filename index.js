		...
		for(i=x;i<cantidadFact;i++){
			if(x < max_fields){ //max input box allowed
				...
				$(wrapper).append('<tr id="tr-'+i+'" ><td>'+i+'</td>'+
								  ...
								  '<td><input class="filasData" id="total"  type="number" name="total"/></td>'+
								  '<td><select  id="periodo" name="periodo" onchange="myFunctioncambiarfeha()"><option value="0">Choose</option><option value="1">Days</option><option value="2">Weeks</option><option value="3">Months</option><option value="4">Years</option></select></td>'+
								  '<td><input class="filasData" id="fechafinal"  type="number" name="fechafinal"/></td>'+
...
function myFunctioncambiarfeha(){
	d = document.getElementById("periodo").value;
    alert(d);
	d = document.getElementById("total").value;
    alert(d);
}
